...
export const mockCampusPPKTPTCases = [
  { id: "PPKTPT-2026-001", campus: "Universitas Indonesia", category: "Doxxing & Penyebaran Konten Tanpa Konsen", victimAlias: "Korban-A92", priority: "Sangat Tinggi", status: "Penyelidikan Satgas", date: "2026-07-25", assignedInvestigator: "Dr. Rina Wijaya, S.H., M.H.", investigationStartedAt: "25 Jul 2026, 09:30 WIB" },
  { id: "PPKTPT-2026-002", campus: "Universitas Gadjah Mada", category: "Pelecehan Seksual Berbasis Siber (KSBS)", victimAlias: "Korban-B44", priority: "Tinggi", status: "Pendampingan Hukum", date: "2026-07-22", assignedInvestigator: "Prof. Dr. Hendra K., M.Si.", investigationStartedAt: "22 Jul 2026, 14:15 WIB" },
  { id: "PPKTPT-2026-003", campus: "Universitas Mataram", category: "Pengancaman Pembocoran Data Pribadi", victimAlias: "Korban-C11", priority: "Sangat Tinggi", status: "Proteksi Identitas Aktif", date: "2026-07-20", assignedInvestigator: "Dr. Ahmad Zaini, S.H.", investigationStartedAt: "20 Jul 2026, 11:00 WIB" }
];
export const mockCampusPPKSCases = mockCampusPPKTPTCases;
...
export const mockLegalExperts = [
  ...
  { id: 2, name: "Dr. Siti Aminah, S.H., LL.M.", role: "Ketua Klinik Hukum Kampus UI", organization: "Satgas PPKTPT & Klinik Legal UI", rating: 5.0, status: "Busy" },
